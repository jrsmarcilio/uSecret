      ...
      <main className="p-6 sm:p-10 space-y-6">
        ...
        <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Secrets</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
          ...
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Polices</span>
            </div>
          </div>
        </section>
        <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
          ...
          <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
            <div className="px-6 py-5 font-semibold border-b border-gray-100">The number of applied and left secrets per month</div>
          ...
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              ...
              <span className="block text-gray-500">Groups</span>
            </div>
          </div>
          <div className="flex items-center p-8 bg-white shadow rounded-lg">
            ...
            <div>
              <span className="block text-2xl font-bold">2.2</span>
              <span className="block text-gray-500">Average usage time per user</span>
            </div>
          </div>
          ...
          <div className="flex flex-col row-span-3 bg-white shadow rounded-lg">
            <div className="px-6 py-5 font-semibold border-b border-gray-100">Users by type groups</div>
            <div className="p-4 flex-grow">
